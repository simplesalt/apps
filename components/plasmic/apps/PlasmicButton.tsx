...
// Plasmic Project: bwZBdGc1jmSjpqkba8o6fa
// Component: OV_w2bVDgVck
...
import sty from "./PlasmicButton.module.css"; // plasmic-import: OV_w2bVDgVck/css
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__nGYid, {
          [sty.freeBoxcolor_neutral__nGYidDvpbg]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxroundedFull__nGYidOdp6N]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__nGYidB7S3K]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__nGYidnzYt1]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__nGYidUazsM]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__nGYidPIsuR]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__nGYidFYNm]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__nGYidFYNmMzHoZ]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___2X18Q, {
            [sty.freeBoxcolor_neutral___2X18QDvpbg]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft___2X18QDvpbgXa2Mf]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart___2X18QKrOl]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge___2X18QB7S3K]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___2X18QUazsM]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___2X18QPIsuR]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered___2X18QFYNm]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__haOtB)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__d4Km, {
            [sty.freeBoxiconEnd__d4KmCa7Um]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__d4KmB7S3K]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__d4KmUazsM]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__d4KmPIsuR]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg___73RiO)}
                role={"img"}
              />
            ),
